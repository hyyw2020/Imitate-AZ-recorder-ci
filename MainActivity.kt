...
class MainActivity : AppCompatActivity() {
    ...
    private val overlayLauncher = registerForActivityResult(
        ...
        else Toast.makeText(this, R.string.permission_overlay_required, Toast.LENGTH_SHORT).show()
    }
    ...
    private val notificationLauncher = registerForActivityResult(
        ...
        else Toast.makeText(this, R.string.permission_notification_required, Toast.LENGTH_LONG).show()
    }
    ...
    private fun setupAudioModeChips() {
        ...
        val autoChip = Chip(this).apply {
            id = View.generateViewId()
            text = getString(R.string.audio_auto)
            isCheckable = true
            tag = AudioMode.AUTO
